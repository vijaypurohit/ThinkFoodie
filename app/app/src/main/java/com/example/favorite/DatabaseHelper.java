    ...
    public ArrayList<ItemLatest> getFavourite() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setRecipeImage(cursor.getString(cursor.getColumnIndexOrThrow(KEY_IMAGE)));
                contact.setRecipeViews(cursor.getString(cursor.getColumnIndexOrThrow(KEY_VIEW)));
                contact.setRecipeCategoryName(cursor.getString(cursor.getColumnIndexOrThrow(KEY_CATNAME)));
