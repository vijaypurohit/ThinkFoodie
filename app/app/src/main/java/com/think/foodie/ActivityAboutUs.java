...
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyFontForToolbarTitle(ActivityAboutUs.this);
    ...
    private void setResult() {
        ...
        Picasso.with(ActivityAboutUs.this).load(Constant.IMAGE_PATH_URL + itemAbout.getAppLogo()).into(imgAppLogo);
        ...
        String text = "<html><head>"
                + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/myfonts/LatoRegular.ttf\")}body{font-family: MyFont;color: #8b8b8b;text-align:justify}"
                + "</style></head>"
                + "<body>"
                + htmlText
                + "</body></html>";
        ...
        for(int i = 0; i < toolbar.getChildCount(); i++){
            ...
            if(view instanceof TextView){
                ...
                Typeface titleFont = Typeface.
                        createFromAsset(context.getAssets(), "myfonts/LatoRegular.ttf");
