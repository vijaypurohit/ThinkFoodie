...
public class CategoryAdapter extends ArrayAdapter<ItemCategory> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txt = (TextView) view.findViewById(R.id.text_cat);
        holder.img_cat = (ImageView) view.findViewById(R.id.image_cat);
        holder.txt.setText(objAllBean.getCategoryName().toString().toUpperCase());

        Picasso.with(activity).load(objAllBean.getCategoryImageurl()).placeholder(R.drawable.ic_category).into(holder.img_cat);
