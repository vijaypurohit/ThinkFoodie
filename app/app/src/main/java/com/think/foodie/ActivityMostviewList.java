...
public class ActivityMostviewList extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		toolbar.setTitle(getString(R.string.home_mostviewed));
		...
		if (JsonUtils.isNetworkAvailable(ActivityMostviewList.this)) {
			new MyTask().execute(Constant.MOSTVIEW_LIST_URL);
		} else {
		...
		lsv_cat.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				PopUpAds.ShowInterstitialAds(ActivityMostviewList.this);
	...
	public void setAdapterToListview() {
		objAdapter = new CategoryListAdapter(ActivityMostviewList.this, R.layout.categorylist_row_item,
				arrayOfCaList,columnWidth);
		lsv_cat.setAdapter(objAdapter);
	}

	public void showToast(String msg) {
		Toast.makeText(ActivityMostviewList.this, msg, Toast.LENGTH_LONG).show();
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String query) {
				// Do something
				Intent intent = new Intent(ActivityMostviewList.this, ActivitySearch.class);
