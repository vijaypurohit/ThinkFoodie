...
public class ActivityCategoryList extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (JsonUtils.isNetworkAvailable(ActivityCategoryList.this)) {
			new MyTask().execute(Constant.CATEGORYLIST_URL+Constant.CATEGORY_IDD);
		} else {
		...
		lsv_cat.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				PopUpAds.ShowInterstitialAds(ActivityCategoryList.this);
	...
	public void setAdapterToListview() {
		objAdapter = new CategoryListAdapter(ActivityCategoryList.this, R.layout.categorylist_row_item,
				arrayOfCaList,columnWidth);
		lsv_cat.setAdapter(objAdapter);
	}

	public void showToast(String msg) {
		Toast.makeText(ActivityCategoryList.this, msg, Toast.LENGTH_LONG).show();
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String query) {
				// Do something
				Intent intent = new Intent(ActivityCategoryList.this, ActivitySearch.class);
